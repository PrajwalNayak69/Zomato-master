    ...
    return (
        <>
            ...
            <div className="hidden w-full h-96 md:flex gap-1">
                ...
                <img src={props.images.length && props.images[0].location}
                    alt="sai's Restaurant"
                className="w-full h-full object-cover rounded-lg transform transistion duration-500 hover:scale-110 " />
                </div>
                ...
                <h4 className="absolute inset-y-2/4 z-20 w-full h-full text-center text-white text-semibold">View Gallary</h4>
                </div>
                <div className="w-full h-full relative" >
                <img src={props.images.length >=4 && props.images[4].location}
                alt="sai's Restaurant"
                className="w-full h-full object-cover rounded-lg transform transistion duration-500 hover:scale-110" />
                <div className="absolute inset-0 bg-opacity-80 bg-gray-700 w-full h-full rounded-lg" />
               <div className="absolute flex flex-col items-center inset-y-1/4 z-20 w-full h-full text-center text-white text-semibold">
