...
const MobileTabs = () => {
        return (
            <>
                <div className="lg:hidden bg-white px-3 py-3 shadow-lg  fixed bottom-0 z-10 w-full flex items-center justify-between md:justify-evenly text-gray-500 border">
        ...
        <>
            <div className="hidden lg:flex gap-14 container px-20 mx-auto">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl text-gray-700 font-semibold">Delievry</h3>
                </div>
                <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-gray-100 p-4 rounded-full">
                    ...
                    <h3 className="text-xl text-gray-700 font-semibold">Dine Out</h3>
                </div>
                <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-gray-100 p-4 rounded-full">
